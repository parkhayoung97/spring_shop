...
<body>
	...
	<div class="admin_content_wrap">
		...
		<div class="admin_content_main">
			<form action="/admin/goodsEnroll" method="post" id="enrollForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="publeYear" id="publeYear_input" type="text"
		...
		<div class="form_section">
			...
			<div class="form_section_content">
				<textarea name="bookIntro" id="bookIntro_textarea" rows="20"
					cols="100"></textarea>
		...
		<div class="form_section">
			...
			<div class="form_section_content">
				<textarea name="bookContents" id="bookContents_textarea" rows="20"
					cols="100"></textarea>
	...
	<script>
		...
		$("#enrollBtn").on("click", function(e) {
			...
			/*공란 체크*/
			if(bookName){
				$(".bookName_wran").css('display','none');
				bookNameCk = true;
			}else {
		...
		$('.authorId_btn').on("click", function(e){
			...
			let popOption = "width = 650px, height=550px, top=300px, scrollbars=yes";
		...
		let cate10bj = new Object();
		let cate20bj = new Object();
		let cate30bj = new Object();
		...
		//배열 초기화
		makeCateArray(cate10bj,cate1Array,cateList,1);
		makeCateArray(cate20bj,cate2Array,cateList,2);
		makeCateArray(cate30bj,cate3Array,cateList,3);
